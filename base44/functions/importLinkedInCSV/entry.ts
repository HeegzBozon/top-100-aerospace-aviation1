...
Deno.serve(async (req) => {
  try {
    ...
    const columnMap = {
      ...
      last_sent_message: headers.indexOf('last_received_message_text'),
      last_sent_date: headers.indexOf('last_received_message_send_at_iso'),
      last_received_message: headers.indexOf('replied_message_1_text'),
      last_received_date: headers.indexOf('replied_message_1_send_at_iso'),
      second_received_message: headers.indexOf('last_sent_message_text'),
      second_received_date: headers.indexOf('last_sent_message_send_at_iso'),
    ...
    for (const row of dataRows) {
      ...
      const contact = {
        ...
        second_received_message: row[columnMap.second_received_message] || '',
        second_received_date: row[columnMap.second_received_date] || '',
