    ...
    >
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <div
            className="h-10 w-10 rounded-lg flex items-center justify-center text-base font-bold"
      ...
      {story ? (
        <p className="text-base lg:text-lg font-semibold italic leading-snug line-clamp-2" style={{ color: brand.navy }}>
      ...
      {bio && (
        <p className="text-xs lg:text-sm leading-relaxed line-clamp-3 lg:line-clamp-6" style={{ color: `${brand.navy}70` }}>{bio}</p>
      )}
    </motion.div>
  );
}