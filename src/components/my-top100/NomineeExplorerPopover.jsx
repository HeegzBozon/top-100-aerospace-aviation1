...
import { Search, X, Plus, Check, Filter, ArrowDownUp, BadgeCheck, Award, ExternalLink, UserPlus, Loader2 } from 'lucide-react';
...
export default function NomineeExplorerPopover({ isOpen, onClose, addedIds, onAdd }) {
      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed left-1/2 top-1/2 z-50 w-[680px] max-w-[94vw] max-h-[86vh] -translate-x-1/2 -translate-y-1/2 rounded-3xl overflow-hidden flex flex-col"
