...
export default function RoomsFooterCTA() {
  return (
    <section className="relative py-24 md:py-40 overflow-hidden" style={{ background: '#020810' }}>
      {/* Moon glow */}
      ...
      {/* Small moon */}
      <motion.div
        className="absolute top-12 right-1/4 w-16 h-16 rounded-full pointer-events-none"
        style={{
          background: 'radial-gradient(circle at 35% 35%, #e8e0d4 0%, #8a7d6d 60%, #4a4035 100%)',
          boxShadow: '0 0 40px 10px rgba(201,168,124,0.08)',
        }}
        animate={{ y: [0, -5, 0] }}
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 md:px-12 text-center">
        ...
        >
          ...
          <p className="text-slate-400 text-lg mb-10 leading-relaxed">
            We're not waiting until it's perfect. We're building it live. From the lunar surface.
          </p>
          ...
          <p className="text-slate-600 text-xs italic">
            One more thing: this page was drafted inside Moon Base Alpha. On station. Of course it was.
          </p>
        </motion.div>
      </div>
    </section>
