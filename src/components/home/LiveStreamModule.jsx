        ...
        <Card className="relative overflow-hidden bg-[#0a1526]/80 backdrop-blur-xl border-[#4a90b8]/20 text-white shadow-2xl">
          ...
          >
            <CarouselContent>
              ...
              <CarouselItem>
                <div className="flex flex-col h-full min-h-[360px] xl:h-[400px] border-t border-[#4a90b8]/20 bg-[#0a1526] relative overflow-hidden">
                  <div className="flex-1 flex flex-col items-center justify-center p-6 md:p-12 text-center relative">
              ...
              <CarouselItem>
                <div className="flex flex-col h-full min-h-[360px] xl:h-[400px] border-t border-[#4a90b8]/20 bg-[#1e3a5a]/40 relative overflow-hidden shadow-inner backdrop-blur-md">
