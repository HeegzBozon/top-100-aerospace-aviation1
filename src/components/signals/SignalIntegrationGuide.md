...
**Usage:**
```jsx
import NomineeSignalsSection from '@/components/signals/NomineeSignalsSection';
...
**Usage:**
```jsx
import SignalBadgeIndicator from '@/components/signals/SignalBadgeIndicator';
...
**Usage:**
```jsx
import LinkedInSignalShare from '@/components/signals/LinkedInSignalShare';
