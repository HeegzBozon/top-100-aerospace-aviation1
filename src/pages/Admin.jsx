...
import AdminSidebar from '@/components/capabilities/admin/AdminSidebar';
import AdminBreadcrumbs from '@/components/capabilities/admin/AdminBreadcrumbs';
import AdminCommandPalette, { addRecentTab } from '@/components/capabilities/admin/AdminCommandPalette';
import { findTabById } from '@/components/capabilities/admin/adminNavConfig';

// Admin content components (eagerly loaded for now — can lazy-load later if bundle grows)
import AdminCommandCenter from '@/components/capabilities/admin/AdminCommandCenter';
import SeasonCommandCenter from '@/components/capabilities/admin/SeasonCommandCenter';
import SeasonManager from '@/components/capabilities/admin/SeasonManager';
import SeasonViewModal from '@/components/capabilities/admin/SeasonViewModal';
import ProviderReviewManager from '@/components/capabilities/admin/ProviderReviewManager';
import ServiceManager from '@/components/capabilities/admin/ServiceManager';
import NomineeManager from '@/components/capabilities/admin/NomineeManager';
import KBArticleManager from '@/components/capabilities/admin/KBArticleManager';
import PlatformSettings from '@/components/capabilities/admin/PlatformSettings';
import UserViewModal from '@/components/capabilities/admin/UserViewModal';
import RankedVoteManager from '@/components/capabilities/admin/RankedVoteManager';
import UniversalDataWizard from '@/components/capabilities/admin/UniversalDataWizard';
import ProfilePhotoDiagnostics from '@/components/capabilities/admin/ProfilePhotoDiagnostics';
import NomineePhotoUploadWizard from '@/components/capabilities/admin/NomineePhotoUploadWizard';
import HeadshotUploadWizard from '@/components/capabilities/admin/HeadshotUploadWizard';
import AssetManager from '@/components/capabilities/admin/AssetManager';
import EventManagement from '@/components/capabilities/admin/EventManagement';
import SponsorManagement from '@/components/capabilities/admin/SponsorManagement';
import AvailabilityManager from '@/components/capabilities/admin/AvailabilityManager';
import ClaimsReviewManager from '@/components/capabilities/admin/ClaimsReviewManager';
import UserMergeManager from '@/components/capabilities/admin/UserMergeManager';
import NomineeAssignmentManager from '@/components/capabilities/admin/NomineeAssignmentManager';
import HolisticScoringPanel from '@/components/capabilities/admin/HolisticScoringPanel';
import VerificationDashboard from '@/components/capabilities/admin/VerificationDashboard';
import ScoringAnalytics from '@/components/capabilities/admin/ScoringAnalytics';
import SalesAnalytics from '@/components/capabilities/admin/SalesAnalytics';
import SMEAssignmentPanel from '@/components/capabilities/admin/SMEAssignmentPanel';
import StartupReviewPanel from '@/components/capabilities/admin/StartupReviewPanel';
import AcceleratorManagement from '@/components/capabilities/admin/AcceleratorManagement';
import EnrollmentManagement from '@/components/capabilities/admin/EnrollmentManagement';
import MilestoneReview from '@/components/capabilities/admin/MilestoneReview';
import CommunityNotesModeration from '@/components/capabilities/admin/CommunityNotesModeration';
import TestimonialModeration from '@/components/capabilities/admin/TestimonialModeration';
import UserManagement from '@/components/capabilities/admin/UserManagement';
import RailItemManager from '@/components/capabilities/admin/RailItemManager';
