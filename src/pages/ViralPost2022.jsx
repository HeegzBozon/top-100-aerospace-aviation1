...
const HonoreeCard = ({ h }) => (
  <article
    className="relative bg-white border rounded-2xl p-7 md:p-9 transition-shadow duration-300 hover:shadow-xl"
    style={{ borderColor: 'rgba(30,58,90,0.14)' }}
  >
    {/* Rank ribbon */}
    <div
      className="absolute -top-px -left-px rounded-tl-2xl rounded-br-2xl px-4 py-2"
    ...
    <div className="flex flex-col h-full">
      <div className="flex items-center gap-4 mb-6 mt-8">
        ...
        <div className="min-w-0">
          <h3 className="font-serif text-xl md:text-2xl font-bold leading-tight" style={{ color: NAVY }}>
            {h.name}
          </h3>
        </div>
      </div>
