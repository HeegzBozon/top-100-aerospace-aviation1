...
import { Building2, BarChart3, Shield, Handshake, ExternalLink, ArrowRight } from 'lucide-react';
    ...
    <div className="min-h-screen" style={{ background: brandColors.cream }}>
      ...
      >
        <div className="max-w-5xl mx-auto text-center">
          <Building2 className="w-12 h-12 mx-auto mb-4" style={{ color: brandColors.goldPrestige }} />
          ...
          <p className="text-white/80 max-w-2xl mx-auto" style={{ fontFamily: "'Montserrat', sans-serif" }}>
            Tools and resources to help your aerospace business thrive
          </p>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto px-4 pb-12">
        ...
        >
          <h3 className="text-xl font-bold mb-2" style={{ color: brandColors.navyDeep, fontFamily: "'Playfair Display', serif" }}>
            Partner with TOP 100
          </h3>
          <p className="text-sm mb-4" style={{ color: brandColors.navyDeep, opacity: 0.7 }}>
            Reach decision-makers across the aerospace and aviation industry
          </p>
