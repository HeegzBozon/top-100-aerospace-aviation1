            ...
            <div className="relative h-full flex flex-col p-16 z-10">
              ...
              <div className="grid grid-cols-2 gap-10 flex-1">
                {[
                  ...
                  <div key={i} className="bg-[#112240] rounded-xl border border-white/10 p-12 flex flex-col justify-center" style={{ borderLeftWidth: 8, borderLeftColor: m.color }}>
                    <h3 className="text-7xl font-bold mb-2 tracking-tight" style={{ color: m.color }}>{m.val}</h3>
                    <p className="text-white/60 text-2xl mb-6">{m.unit}</p>
                    <p className="text-white text-3xl leading-relaxed font-light whitespace-pre-line">{m.desc}</p>
                  </div>
                ))}
              </div>
            </div>
