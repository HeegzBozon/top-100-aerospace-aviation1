          ...
          >
            <div className="inline-block mb-6">
              <div className="flex items-center gap-2 px-4 py-2 rounded-full border border-white/20" style={{ background: 'rgba(255,255,255,0.1)' }}>
                ...
                <span className="text-white/90 text-sm font-medium">Partnership Opportunities</span>
              </div>
            </div>
            ...
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6" style={{
              ...
              <span style={{ color: brandColors.goldPrestige }}>Shape the Future.</span>
            </h1>
            
            <p className="text-xl md:text-2xl text-white/80 max-w-3xl mx-auto mb-12">
              Partner with TOP 100 Aerospace & Aviation to connect with the industry's most influential voices and rising stars.
            </p>
      ...
      <section className="py-20" style={{ background: brandColors.cream }}>
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          >
            ...
            <Button
              size="lg"
              onClick={() => window.location.href = 'mailto:partners@top100aerospace.com?subject=Custom%20Partnership%20Inquiry'}
              className="text-lg px-8 py-6"
              style={{ background: brandColors.goldPrestige, color: 'white' }}
            >
              Let's Talk
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button
                size="lg"
                variant="outline"
                onClick={() => window.open('https://calendly.com/top100aerospace', '_blank')}
                className="text-lg px-8 py-6 border-white/30 text-white hover:bg-white/10"
              >
