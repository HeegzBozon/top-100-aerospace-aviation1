...
import HangarScene from '@/components/epics/03-mission-rooms/games/hangar/HangarScene';
import OutsideScene from '@/components/epics/03-mission-rooms/games/hangar/OutsideScene';
import UnifiedGameHUD from '@/components/epics/03-mission-rooms/games/hangar/UnifiedGameHUD';
import HangarAudio from '@/components/epics/03-mission-rooms/games/hangar/HangarAudio';
import InteractionPrompt from '@/components/epics/03-mission-rooms/games/hangar/InteractionPrompt';
import AreaDiscoveryToast from '@/components/epics/03-mission-rooms/games/hangar/AreaDiscoveryToast';
import ArtifactPickup from '@/components/epics/03-mission-rooms/games/hangar/ArtifactPickup';
import HologramDisplay from '@/components/epics/03-mission-rooms/games/hangar/HologramDisplay';
import InventoryPanel from '@/components/epics/03-mission-rooms/games/hangar/InventoryPanel';
import PauseMenu from '@/components/epics/03-mission-rooms/games/hangar/PauseMenu';
import MiniGameHub from '@/components/epics/03-mission-rooms/games/minigames/MiniGameHub';
import MissionBoard from '@/components/epics/03-mission-rooms/games/missions/MissionBoard';
import OnboardingSequence from '@/components/epics/03-mission-rooms/games/hangar/OnboardingSequence';
